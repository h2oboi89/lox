...
- [x] [Evaluating Expressions](http://craftinginterpreters.com/parsing-expressions.html) : [EvaluatingExpressions](https://github.com/h2oboi89/lox/releases/tag/EvaluatingExpressions)
